package com.example.fln.activities.animals;
...
public class AnimalSpellActivity extends QuestionActivity {
    ...
    protected void setViewsAndLayout() {
        setContentView(R.layout.animals_spell);
    ...
    protected void setQuestion() {
        question = (AnimalSpellQuestion) getIntent().getSerializableExtra("question");
        if (question == null || question.getImage() == null) {
            Log.e("Animal Spell", "Question Image not set.");
        } else {
