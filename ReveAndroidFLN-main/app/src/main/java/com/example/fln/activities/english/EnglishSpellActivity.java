...
package com.example.fln.activities.english;
...
public class EnglishSpellActivity extends QuestionActivity {
    ...
    protected void setViewsAndLayout() {
        setContentView(R.layout.english_spell);
    ...
    protected void setQuestion() {
        question = (EnglishSpellQuestion) getIntent().getSerializableExtra("question");
        if (question == null || question.getImage() == null) {
            Log.e("English Spell", "Question Image not set.");
        } else {
