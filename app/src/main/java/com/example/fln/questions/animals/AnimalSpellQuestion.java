package com.example.fln.questions.animals;
...
public class AnimalSpellQuestion extends Question {
    Mappings mappings = new Mappings();
    InverseMappings invMappings = new InverseMappings(mappings);

    public AnimalSpellQuestion() {
        super();
    }

    public AnimalSpellQuestion(String question_image_url, String answer) {
