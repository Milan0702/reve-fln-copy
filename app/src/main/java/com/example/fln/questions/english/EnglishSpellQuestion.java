package com.example.fln.questions.english;
...
public class EnglishSpellQuestion extends Question {
    Mappings mappings = new Mappings();
    InverseMappings invMappings = new InverseMappings(mappings);

    public EnglishSpellQuestion() {
        super();
    }

    public EnglishSpellQuestion(String question_image_url, String answer) {
